  ...
  return (
    <div>
      <section className="mx-auto max-w-6xl px-5 pt-14 sm:pt-20 pb-10">
        ...
        <h1 className="font-serif text-4xl sm:text-6xl tracking-tight mt-4 max-w-4xl leading-[1.08]">
      ...
      <section className="bg-dossier text-dossier-text mt-10">
        <div className="mx-auto max-w-6xl px-5 py-12">
          ...
          <p className="mt-5 text-[13px] text-dossier-faint">
            Read the full{" "}
            <Link href="/method/" className="underline decoration-copper/60 underline-offset-2 hover:text-dossier-text">
              methodology
            </Link>
